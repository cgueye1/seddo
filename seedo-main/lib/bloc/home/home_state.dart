...
class HomeState extends Equatable {
  ...
  final Set<int> reservedPublications;
  ...
  const HomeState({
    ...
    this.reservedPublications = const {},
  ...
  HomeState copyWith({
    ...
    return HomeState(
      ...
      reservedPublications: reservedPublications ?? this.reservedPublications,
